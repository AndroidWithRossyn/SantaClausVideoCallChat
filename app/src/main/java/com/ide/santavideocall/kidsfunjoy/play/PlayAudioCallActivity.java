...
public class PlayAudioCallActivity extends Activity implements SurfaceHolder.Callback {
    long a = 0;
    Camera b;
    drf c = new drf(this);
    boolean d = false;
    ...
    public void a() {
        new Handler().postDelayed(new Runnable() {
            public void run() {
                PlayAudioCallActivity.this.e.setVisibility(View.VISIBLE);
            }
        }, 2000);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_audio_call);
        AppManage.getInstance(PlayAudioCallActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
        //todo Ad Loading Dialog
        adprogress = new Dialog(PlayAudioCallActivity.this, R.style.Custom);
        ...
        this.i.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                try {
                    PlayAudioCallActivity.this.i.requestFocus();
                    PlayAudioCallActivity.this.i.start();
                } catch (Exception e) {
        ...
        this.i.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mediaPlayer) {
                ...
                PlayAudioCallActivity.this.finish();
            }
        });
...
//
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            startActivity(new Intent(PlayAudioCallActivity.this, VoiceMeetingActivity.class));
        } else {

...
public class PlayMrsSantaVideoCallActivity extends Activity implements SurfaceHolder.Callback {
    long a = 0;
    Camera b;
    drf c = new drf(this);
    boolean d = false;
    ...
    public void a() {
        new Handler().postDelayed(new Runnable() {
            public void run() {
                PlayMrsSantaVideoCallActivity.this.e.setVisibility(View.GONE);
            }
        }, 2000);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_mrs_santa_video_call);
        AppManage.getInstance(PlayMrsSantaVideoCallActivity.this).loadInterstitialAd(this);
        AppManage.getInstance(PlayMrsSantaVideoCallActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);

        //todo Ad Loading Dialog
        adprogress = new Dialog(PlayMrsSantaVideoCallActivity.this, R.style.Custom);
...
//        }
        ...
        this.i.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                try {
                    PlayMrsSantaVideoCallActivity.this.i.requestFocus();
                    PlayMrsSantaVideoCallActivity.this.i.start();
                } catch (Exception e) {
        ...
        this.i.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mediaPlayer) {
                PlayMrsSantaVideoCallActivity play_Video_Call_Activity = PlayMrsSantaVideoCallActivity.this;
                play_Video_Call_Activity.d = true;
                play_Video_Call_Activity.a("Call ended...");
                PlayMrsSantaVideoCallActivity.this.finish();
            }
        });
...
//            } else if (adsdata.get(0).getCheckadEndcallInter().equals("off")) {
        ...
        if (videoView != null) {
            ...
            startActivity(new Intent(PlayMrsSantaVideoCallActivity.this, DashboardActivity.class));
            finish();
        }
        startActivity(new Intent(PlayMrsSantaVideoCallActivity.this, DashboardActivity.class));
    }
    ...
    public void onBackPressed() {
        ...
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            AppManage.getInstance(PlayMrsSantaVideoCallActivity.this).showInterstitialAd(PlayMrsSantaVideoCallActivity.this, new AppManage.MyCallback() {

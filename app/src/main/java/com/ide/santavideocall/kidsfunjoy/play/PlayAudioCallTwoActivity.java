...
public class PlayAudioCallTwoActivity extends Activity implements SurfaceHolder.Callback {
    long a = 0;
    Camera b;
    drf c = new drf(this);
    boolean d = false;
    ...
    public void a() {
        new Handler().postDelayed(new Runnable() {
            public void run() {
                PlayAudioCallTwoActivity.this.e.setVisibility(View.VISIBLE);
            }
        }, 2000);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_audio_call_two);
        AppManage.getInstance(PlayAudioCallTwoActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
        //todo Ad Loading Dialog
        adprogress = new Dialog(PlayAudioCallTwoActivity.this, R.style.Custom);
        ...
        this.i.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                try {
                    PlayAudioCallTwoActivity.this.i.requestFocus();
                    PlayAudioCallTwoActivity.this.i.start();
                } catch (Exception e) {
        ...
        this.i.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mediaPlayer) {
                PlayAudioCallTwoActivity playAudioCallActivity = PlayAudioCallTwoActivity.this;
                playAudioCallActivity.d = true;
                playAudioCallActivity.a("Call ended...");
                PlayAudioCallTwoActivity.this.finish();
            }
        });
...
//
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            startActivity(new Intent(PlayAudioCallTwoActivity.this, VoiceMeetingActivity.class));
        } else {

...
public class PlayAudioFourActivity extends Activity implements SurfaceHolder.Callback {
    long a = 0;
    Camera b;
    drf c = new drf(this);
    boolean d = false;
    ...
    public void a() {
        new Handler().postDelayed(new Runnable() {
            public void run() {
                PlayAudioFourActivity.this.e.setVisibility(View.VISIBLE);
            }
        }, 2000);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_audio_four);
        AppManage.getInstance(PlayAudioFourActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
        //todo Ad Loading Dialog
        adprogress = new Dialog(PlayAudioFourActivity.this, R.style.Custom);
        ...
        this.i.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                try {
                    PlayAudioFourActivity.this.i.requestFocus();
                    PlayAudioFourActivity.this.i.start();
                } catch (Exception e) {
        ...
        this.i.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mediaPlayer) {
                PlayAudioFourActivity playAudioCallActivity = PlayAudioFourActivity.this;
                playAudioCallActivity.d = true;
                playAudioCallActivity.a("Call ended...");
                PlayAudioFourActivity.this.finish();
            }
        });
...
//
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            startActivity(new Intent(PlayAudioFourActivity.this, VoiceMeetingActivity.class));
        } else {

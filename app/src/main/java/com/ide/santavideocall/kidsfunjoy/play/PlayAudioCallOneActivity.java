...
import com.ide.santavideocall.kidsfunjoy.activity.VoiceMeetingActivity;
import com.ide.santavideocall.kidsfunjoy.drf;
import com.pesonal.adsdk.AppManage;

import java.io.IOException;

public class PlayAudioCallOneActivity extends Activity implements SurfaceHolder.Callback {
    long a = 0;
    Camera b;
    drf c = new drf(this);
    boolean d = false;
    ...
    public void a() {
        new Handler().postDelayed(new Runnable() {
            public void run() {
                PlayAudioCallOneActivity.this.e.setVisibility(View.VISIBLE);
            }
        }, 2000);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_audio_call_one);
        AppManage.getInstance(PlayAudioCallOneActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
        //todo Ad Loading Dialog
        adprogress = new Dialog(PlayAudioCallOneActivity.this, R.style.Custom);
        ...
        this.i.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                try {
                    PlayAudioCallOneActivity.this.i.requestFocus();
                    PlayAudioCallOneActivity.this.i.start();
                } catch (Exception e) {
        ...
        this.i.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mediaPlayer) {
                PlayAudioCallOneActivity playAudioCallActivity = PlayAudioCallOneActivity.this;
                playAudioCallActivity.d = true;
                playAudioCallActivity.a("Call ended...");
                PlayAudioCallOneActivity.this.finish();
            }
        });
...
//
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            startActivity(new Intent(PlayAudioCallOneActivity.this, VoiceMeetingActivity.class));
        } else {

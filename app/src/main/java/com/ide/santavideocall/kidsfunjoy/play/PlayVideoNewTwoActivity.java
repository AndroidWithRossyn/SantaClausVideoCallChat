...
public class PlayVideoNewTwoActivity extends Activity implements SurfaceHolder.Callback {
    long a = 0;
    Camera b;
    drf c = new drf(this);
    boolean d = false;
    ...
    public void a() {
        new Handler().postDelayed(new Runnable() {
            public void run() {
                PlayVideoNewTwoActivity.this.e.setVisibility(View.GONE);
            }
        }, 2000);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_video_new_two);

        AppManage.getInstance(PlayVideoNewTwoActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);

        //todo Ad Loading Dialog
        adprogress = new Dialog(PlayVideoNewTwoActivity.this, R.style.Custom);
...
//        }
        ...
        this.i.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                try {
                    PlayVideoNewTwoActivity.this.i.requestFocus();
                    PlayVideoNewTwoActivity.this.i.start();
                } catch (Exception e) {
        ...
        this.i.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mediaPlayer) {
                PlayVideoNewTwoActivity play_Video_CallTwo_Activity = PlayVideoNewTwoActivity.this;
                play_Video_CallTwo_Activity.d = true;
                play_Video_CallTwo_Activity.a("Call ended...");
                PlayVideoNewTwoActivity.this.finish();
            }
        });
...
//            } else if (adsdata.get(0).getCheckadVideocallbackpressInter().equals("off")) {
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            startActivity(new Intent(PlayVideoNewTwoActivity.this, VideoMeetingActivity.class));
        } else {

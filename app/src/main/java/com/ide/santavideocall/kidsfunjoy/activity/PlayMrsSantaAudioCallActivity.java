...
public class PlayMrsSantaAudioCallActivity extends Activity implements SurfaceHolder.Callback {
    long a = 0;
    Camera b;
    drf c = new drf(this);
    boolean d = false;
    ...
    public void a() {
        new Handler().postDelayed(new Runnable() {
            public void run() {
                PlayMrsSantaAudioCallActivity.this.e.setVisibility(View.VISIBLE);
            }
        }, 2000);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_mrs_santa_audio_call);

        AppManage.getInstance(PlayMrsSantaAudioCallActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);

        //todo Ad Loading Dialog
        adprogress = new Dialog(PlayMrsSantaAudioCallActivity.this, R.style.Custom);
        ...
        String str2 = "/";
        sb2.append(str2);
        sb2.append(R.raw.mrs_claus_audio);
...
//            sb3.append(str2);
//            sb3.append(R.raw.mrs_claus_audio);
...
//        }
        ...
        this.i.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                try {
                    PlayMrsSantaAudioCallActivity.this.i.requestFocus();
                    PlayMrsSantaAudioCallActivity.this.i.start();
                } catch (Exception e) {
        ...
        this.i.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mediaPlayer) {
                PlayMrsSantaAudioCallActivity playAudioCallActivity = PlayMrsSantaAudioCallActivity.this;
                playAudioCallActivity.d = true;
                playAudioCallActivity.a("Call ended...");
                PlayMrsSantaAudioCallActivity.this.finish();
            }
        });
...
//                this.b.setPreviewDisplay(this.g.getHolder());
    ...
    public void end_call(View view) {
        ...
        if (videoView != null) {
            ...
            startActivity(new Intent(PlayMrsSantaAudioCallActivity.this, DashboardActivity.class));
            finish();
        }
    }
    ...
    public void onBackPressed() {
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            Toast.makeText(getBaseContext(), "Audio call session will end if you presss again", Toast.LENGTH_SHORT).show();
        }

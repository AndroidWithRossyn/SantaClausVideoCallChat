...
public class PlayVideoOneActivity extends Activity implements SurfaceHolder.Callback {
    long a = 0;
    Camera b;
    drf c = new drf(this);
    boolean d = false;
    ...
    public void a() {
        new Handler().postDelayed(new Runnable() {
            public void run() {
                PlayVideoOneActivity.this.e.setVisibility(View.GONE);
            }
        }, 2000);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_video_one);

        AppManage.getInstance(PlayVideoOneActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);

        //todo Ad Loading Dialog
        adprogress = new Dialog(PlayVideoOneActivity.this, R.style.Custom);
        ...
        this.i.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                try {
                    PlayVideoOneActivity.this.i.requestFocus();
                    PlayVideoOneActivity.this.i.start();
                } catch (Exception e) {
        ...
        this.i.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mediaPlayer) {
                PlayVideoOneActivity play_Video_CallOne_Activity = PlayVideoOneActivity.this;
                play_Video_CallOne_Activity.d = true;
                play_Video_CallOne_Activity.a("Call ended...");
                PlayVideoOneActivity.this.finish();
            }
        });
    ...
    public void onBackPressed() {
        ...
        if (this.a + 2000 > System.currentTimeMillis()) {
            ...
            startActivity(new Intent(PlayVideoOneActivity.this, VideoMeetingActivity.class));
        } else {
